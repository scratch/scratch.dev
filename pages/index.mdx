...
You can change styles and customize the page wrapper component by modifying the files in the `src/` directory:
...
scratch revert [file] --force   # overwrite without confirmation
