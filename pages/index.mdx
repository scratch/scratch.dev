...
Scratch makes beautiful static websites with Markdown and React.
...
Scratch compiles Markdown (.md, .mdx) and React (.tsx, .ts, .jsx, js) into beautiful static websites that can be hosted anywhere.

Write in Markdown, and embed React components, like this counter:

<Counter />

Use components to style text <Fire>like this</Fire>
