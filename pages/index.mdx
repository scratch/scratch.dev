...
Write in Markdown and embed React components right in your text. Scratch compiles your work into beautiful static websites like [this one](https://github.com/scratch/scratch.dev).
...
```bash
# Create a new project
scratch create [path]     # create project
