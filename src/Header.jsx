  ...
  return (
    <header className="not-prose flex justify-between items-center mb-4">
      ...
      <nav className="flex gap-6">
        <a href="/docs/" className="opacity-50 hover:opacity-100 transition-opacity">Docs</a>
      </nav>
      <div className="flex gap-4">
        <a href="https://github.com/scratch/scratch" target="_blank" rel="noopener noreferrer" className="opacity-50 hover:opacity-100 transition-opacity">
